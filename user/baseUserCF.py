...
for line in open("/home/f/clothing/user/cache.txt"):
...
class recommender:
    ...
    def recommend(self, user):
        ...
        # 将与user最相近的k个人中user没有看过的服装推荐给user，并且这里又做了一个分数的计算排名
        for i in range(self.k):
...
def adjustrecommend(id):
    ...
    for i in range(len(k)):
        clothingid_list.append(k[i][0])
    return clothingid_list
