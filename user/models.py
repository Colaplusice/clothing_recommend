...
class Clothing(models.Model):
    name = models.CharField(verbose_name="服装名称", max_length=32)
    intro = models.TextField(verbose_name="描述")
    tags = models.ForeignKey(Tags, verbose_name='标签', blank=True, on_delete=models.CASCADE)
    ...
    pic = models.FileField(verbose_name="封面图片", max_length=64, upload_to='clothing_cover')
...
class Rate(models.Model):
    clothing = models.ForeignKey(
        Clothing, on_delete=models.CASCADE, blank=True, null=True, verbose_name="服装id"
    )
...
class Num(models.Model):
    ...
    clothings = models.IntegerField(verbose_name="服装数量", default=0)
