...
urlpatterns = [
    path("", views.all_clothing, name="index"),
    path("login/", views.login, name="login"),
    path("register/", views.register, name="register"),
    path("logout/", views.logout, name="logout"),
    # path("item/", views.item, name="item"),
    path("all_clothing/", views.all_clothing, name="all_clothing"),
    path("clothing/<int:clothing_id>/", views.clothing, name="clothing"),
    path("score/<int:clothing_id>/", views.score, name="score"),
    path("comment/<int:clothing_id>/", views.commen, name="comment"),
    path("good/<int:commen_id>/<int:clothing_id>/", views.good, name="good"),
    path("collect/<int:clothing_id>/", views.collect, name="collect"),
    path("decollect/<int:clothing_id>/", views.decollect, name="decollect"),
    ...
    # 收藏最多
    path("hot_clothing/", views.hot_clothing, name="hot_clothing"),
    path("most_view/", views.most_view, name="most_view"),
    path("most_mark/", views.most_mark, name="most_mark"),
    path("latest_clothing/", views.latest_clothing, name="latest_clothing"),
    ...
    path("als_recommend/", views.als_recommend, name="als_recommend"),
